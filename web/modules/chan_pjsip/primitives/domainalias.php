...
class DomainAlias extends \module\Subject {

  /**
   * Приватное свойство со ссылкой на класс реализующий интерфейс коллекции
   *
   * @var \pjsip\DomainAliases $collection
   */
  public static $collection = 'pjsip\\DomainAliases';
  ...
  public function __construct(string $id = null) {
    ...
    if(isset($this->ini->$id)) {
      $v = $this->ini->$id;
      if(isset($v->type)&&($v->type=='domain_alias')) {
  ...
  public function save() {
    ...
    $this->ini->$entry->type='domain_alias';
