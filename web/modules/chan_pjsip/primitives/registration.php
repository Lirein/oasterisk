...
class Registration extends \module\Subject {

  /**
   * Приватное свойство со ссылкой на класс реализующий интерфейс коллекции
   *
   * @var \pjsip\Registrations $collection
   */
  public static $collection = 'pjsip\\Registrations';
  ...
  public function __construct(string $id = null) {
    ...
    if(isset($this->ini->$id)) {
      $v = $this->ini->$id;
      if(isset($v->type)&&($v->type=='registration')) {
  ...
  public function save() {
    ...
    $this->ini->$entry->type='registration';
