...
class DomainAliases extends \module\Collection {
  ...
  public function rewind() {
    ...
    foreach($this->ini as $k => $v) { 
      if(self::checkEffectivePriv('pjsip', $k, 'settings_reader')&&isset($v->type)&&($v->type=='domain_alias')) {
        $this->items[] = $k;
      }
    }
    reset($this->items);
