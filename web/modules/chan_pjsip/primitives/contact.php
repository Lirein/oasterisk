...
class Contact extends \module\Subject {

  /**
   * Приватное свойство со ссылкой на класс реализующий интерфейс коллекции
   *
   * @var \pjsip\Contacts $collection
   */
  public static $collection = 'pjsip\\Contacts';
  ...
  public function __construct(string $id = null) {
    ...
    if(isset($this->ini->$id)) {
      $v = $this->ini->$id;
      if(isset($v->type)&&($v->type=='contact')) {
