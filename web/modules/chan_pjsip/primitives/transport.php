...
class Transport extends \module\Subject {

  /**
   * Приватное свойство со ссылкой на класс реализующий интерфейс коллекции
   *
   * @var \pjsip\Transports $collection
   */
  public static $collection = 'pjsip\\Transports';
  ...
  public function __construct(string $id = null) {
    ...
    if(isset($this->ini->$id)) {
      $v = $this->ini->$id;
      if(isset($v->type)&&($v->type=='transport')) {
