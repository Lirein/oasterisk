...
class planfixCompanyList extends \scheduler\Contact {
  ...
  protected function fetch(int $first) {
    ...
    $contacts = array();
    $request = \planfix\PlanfixModule::requestContactCompanyList(null, static::$maxbuffer, intdiv($first, static::$maxbuffer)+1);
