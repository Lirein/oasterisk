 ...
 */
class WirelessAdapters extends \core\NetworkAdapters {
  ...
  public function rewind() {
    ...
    if($dh = opendir($dir)) {
      while(($file = readdir($dh)) !== false) {
        if(is_dir($dir. '/'.$file.'/device')&&(trim(file_get_contents($dir. '/'.$file.'/device/class')) == '0x028000')) {
  ...
  public function current() {
    ...
    return new WirelessAdapter($adapter);
  }
