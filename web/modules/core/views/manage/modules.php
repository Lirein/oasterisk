...
class ModulesManage extends \view\View {
  ...
  public static function getMenu() {
    return (object) array('name' => 'Управление модулями', 'prio' => 10, 'icon' => 'oi oi-puzzle-piece', 'mode' => 'expert');
  }
  ...
  public function json(string $request, \stdClass $request_data) {
    ...
    switch($request) {
      case "desc": {
        $result = self::returnResult(\ModulesSettings::_getModuleDesc());
      } break;
      case "list": {
  ...
  public function implementation() {
    ...
    <script>
      ...
      function mapModule(section, name) {
        var result=name;
        if(isSet(desc[section])) {
          if(isSet(desc[section][name])) {
      ...
      function updateDescriptions() {
        this.sendRequest('desc').success(function(data) {
          desc = data;
        });
      }

      function updateModules() {
        this.sendRequest('list').success(function(data) {
          $('#module-list').html('');
...
<?php } ?>
      ...
      function loadModule(module) {
        this.sendRequest('load', {module: module}).success(function(data) {
      ...
      function unloadModule(module) {
        this.sendRequest('unload', {module: module}).success(function(data) {
          var amodule=$('#module-'+module);
      ...
      function reloadModule(module) {
        this.sendRequest('reload', {module: module}).success(function(data) {
