...
class RoomStatistics extends \core\ViewModule {
...
?>
      ...
      $(function () {
        ...
        obj = new widgets.table(card, {id: 'cdr', head: {date: _('Дата'), name: _('Комната'), start: _('Начало'), end: _('Окончание'), duration: _('Длительность'), count: _('Всего участников')}, value: [], clean: true});
